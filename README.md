...
**Grade 5** (6 units), **Grade 1** (4 units: Light & Sound, Plant & Animal Parts, Parents & Their Young, Patterns in the Sky), **Grade 2** (4 units: Materials, Plants & Pollinators, Habitats, Earth Changes) and **Grade 3** (4 units: Forces & Motion, Life Cycles & Traits, Survival & Adaptations, Weather & Climate) are complete. **Grade 4** coming. Each grade's units live in its own array (`GRADE1`…`GRADE4`, plus `UNITS` for Grade 5). Sort/classify activities shuffle their items so the answer order is not a giveaway; every slide has a Back button.
